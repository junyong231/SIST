...
//주민번호로 만나이 뽑기
	...
	private static int getAmericanAge(String rrn) {//'생일'지났는지 체크가 핵심인 메소드니까= 월일부분 가져와 쓰는게 시작
	...
	private static int getYearAge(String rrn) {//내가 아는 정보는 주민번호니까 여기서 뽑아낼 정보 뽑는다고 생각하면
		//코드 시작하기 쉽지
